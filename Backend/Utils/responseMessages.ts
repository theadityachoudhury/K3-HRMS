...
export const NOT_FOUND = 'Resource you are trying to access is not found';
...
export const INCORRECR_PASSWORD = 'Incorrect password';

export const LOGIN_SUCCESS = 'Login successful';

export const MAX_SESSIONS = 'You have reached the maximum number of sessions';
...
export const USER_IS_DELETED = 'Your account is deleted!! Please contact the support team for further assistance.';

export const USER_IS_DISABLED = 'Your account is disabled by the admin!! Please contact the support team for further assistance.';
...
export const ONLY_KIIT_EMAIL_ALLOWED = 'Only KIIT email is allowed';
