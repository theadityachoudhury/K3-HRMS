        ...
        <div className="space-y-10 w-full">
          <div className="space-y-1">
            <div className="text-3xl font-semibold">
              Login to <span className="font-bold">{config.APP_NAME}</span>
            </div>
          ...
          <div className="space-y-5 mx-5 sm:max-w-lg lg:max-w-lg sm:mx-auto">
            ...
            <div className="space-y-2">
              ...
              <div
                className="bg-black text-white p-3 cursor-pointer hover:bg-indigo-600 hover:text-gray-100 duration-150 ease-linear"
                onClick={() => {
              ...
              <div className="">
                <div className="flex flex-col text-left space-y-2">
                  ...
                  <input
                    ...
                    className="p-3 px-3 w-full border border-black placeholder:text-slate-500 text-md"
                    {...register("email")}
