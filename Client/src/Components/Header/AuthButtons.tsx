      ...
      {ready ? (
        isLoggedIn() ? (
          <button
            ...
            className="border border-black font-semibold hover:bg-gray-800 py-2 px-4"
          >
            Logout
          </button>
        ) : (
          <div className="flex space-x-3">
            <Link to="/login">
              <button className="border border-black font-semibold hover:bg-black hover:text-white duration-150 ease-linear py-2 px-4">
                Login
              </button>
            </Link>
